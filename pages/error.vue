<template>
  <div class="min-h-screen bg-gray-50 px-4 py-16 dark:bg-gray-900 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
    <div class="mx-auto max-w-max">
      <main class="sm:flex">
        <p class="text-4xl font-bold tracking-tight text-primary-600 sm:text-5xl">{{ error?.statusCode || 500 }}</p>
        <div class="sm:ml-6">
